...
contract SmartContractVersionsLedger is HelperFunctions
{
   ...
   function CreateNewVersion (address contractAddress,uint256 version) public returns (string message)
   {
   ...
   function UpdateContractVersion(address oldVersion,address newVersion,uint256 version) public returns (string message)
   {
   ...
   function GetContractStatus(address contractAddress) view public returns (bool found)
   {
